...
- [下载正式签名 APK](https://github.com/N3urda/hongguoTV/releases/tag/kotlin-v0.4.0)
...
1. 将 `hongguotv-kotlin-0.4.0-android8.apk` 拷贝到电视，允许文件管理器安装应用后打开 APK；或执行 `adb install -r hongguotv-kotlin-0.4.0-android8.apk`。
...
# 输出：outputs/hongguotv-kotlin-0.4.0-android8.apk
```
